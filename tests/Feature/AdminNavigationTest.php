...
class AdminNavigationTest extends TestCase
{
    ...
    {
        // Simulates the key being entirely absent (e.g. config/log-viewer.php
        // missing from a stale deploy) - Config::set(..., null) wouldn't
        // reproduce this, since config()'s default only applies when the
        // key doesn't exist at all, not when it exists as null.
