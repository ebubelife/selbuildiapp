...
- **Phase 5 — Roles Expansion** 🟡 *(in progress — contractor projects + supplier dashboard done, admin panel not started)*: registration is now a 3-way Customer/Contractor/Supplier tab. Contractors get a "My Projects" page (create/list/detail), a dashboard summary, and an optional project-link dropdown at checkout — spend and budget-remaining are computed live off linked orders. 10 new feature tests, 66/66 passing.
  ...
  - **Filament admin panel**: still open — supplier/contractor verification queues, catalog moderation, order oversight, and replacing the `credit:review` command.
