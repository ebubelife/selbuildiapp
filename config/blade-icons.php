    ...
    */
    ...
    'components' => [
        ...
        */
        ...
        |
        | Set to null here (rather than the package default of "icon") -
        | Filament's dependencies (blade-heroicons) pull this package in,
        | and its generic <x-icon> component collides with this app's own
        | resources/views/components/icon.blade.php, which predates
        | Filament and uses the same tag name for a completely different
        | (hand-drawn, semantic-name) icon set. Filament itself never uses
        | <x-icon> internally, so disabling it here is safe.
        |
        */
